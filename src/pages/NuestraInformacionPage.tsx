    ...
    <div className="container-shell py-12">
      ...
      <section className="overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-900">
        ...
        <div className="space-y-4 p-6 md:p-10">
          <h1 className="text-3xl font-semibold md:text-4xl">Nuestra Informacion</h1>

          <p className="text-neutral-300">
            <strong>Marina&apos;s Clothes</strong> es una tienda de ropa en linea donde puedes encontrar una gran variedad de
          ...
          <p className="text-neutral-300">
            La tienda fue fundada por <strong>Marina Quinteros</strong>, una mujer luchadora y madre soltera que cada dia
          ...
          <p className="text-neutral-300">
            En <strong>Marina&apos;s Clothes</strong> buscamos ofrecer productos nuevos, utiles y a buen precio, pensando
