...
export default function NuestraInformacionPage() {
  return (
    <div className="container-shell py-12">
      ...
      <section className="overflow-hidden rounded-2xl border border-luxury-200/70 bg-white shadow-lg shadow-luxury-900/8">
        <OptimizedImage
        ...
        <div className="space-y-5 p-6 md:p-10">
          <h1 className="text-3xl font-semibold text-slate-950 md:text-4xl">Nuestra información</h1>

          <p className="leading-relaxed text-slate-600">
            <strong className="text-slate-950">Marina&apos;s Clothes</strong> es una tienda de ropa en línea donde puedes encontrar una gran variedad de
          ...
          <p className="leading-relaxed text-slate-600">
            La tienda fue fundada por <strong className="text-slate-950">Marina Quinteros</strong>, una mujer luchadora y madre soltera que cada día
          ...
          <p className="leading-relaxed text-slate-600">
            En <strong className="text-slate-950">Marina&apos;s Clothes</strong> buscamos ofrecer productos nuevos, útiles y a buen precio, pensando
