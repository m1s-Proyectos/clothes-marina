    ...
    >
      ...
      <div className="pt-2">
        ...
        <button
          ...
          className="mt-2 flex min-h-[44px] w-full items-center justify-center gap-2 rounded-lg bg-luxury-400 px-3 text-[11.5px] font-semibold uppercase tracking-[0.08em] text-surface-base transition-colors hover:bg-luxury-300 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-luxury-300/70"
        >
